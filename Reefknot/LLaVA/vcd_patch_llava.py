...
if __name__ == "__main__":
    ...
    if args.cd_mode not in ["patched_cd", "full_cd", "no_cd", "shuffle_cd", "flip_cd","dino_cd", "dino_without_noise_cd"]:
        raise RuntimeError(f"Invalid cd_mode {args.cd_mode}, should be one of patched_cd, full_cd, no_cd, shuffle_cd, flip_cd, dino_cd, dino_without_noise_cd")
